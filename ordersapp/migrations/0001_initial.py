# Generated by Django 4.0.3 on 2022-07-04 16:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлено в обработку'), ('PRD', 'обработан'), ('PD', 'оплачен'), ('RD', 'готов к выдаче'), ('CNC', 'отменен'), ('DVD', 'выдан')], default='FM', max_length=3, verbose_name='статус')),
